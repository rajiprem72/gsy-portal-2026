...
(function () {
  ...
  function Pair_Initialize_() {
    ...
    /*
      Important:
      Pair mode is intercepted here before the existing generic
      catalogue handler in profile.html gets a chance to process it.
    */
  ...
  async function Pair_SearchParticipant_() {
    ...
    try {
      ...
      const idToken =
        await ctx.auth.currentUser.getIdToken(
          true
        );
