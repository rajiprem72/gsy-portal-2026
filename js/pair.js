...
(function () {
  ...
  async function Pair_SearchParticipant_() {
    ...
    try {
      ...
      try {
        ...
        console.error(
          "Pair partner API response was not JSON:",
          response.status,
          responseText
        );

        throw new Error(
          "Pair partner lookup returned an invalid server response (HTTP " +
          response.status +
          ")."
        );
      }
    ...
    try {
      ...
      */
      ...
      if (!partnerParticipantId) {
        throw new Error(
          "Partner Participant ID is missing."
        );
      }
      ...
      try {
        ...
        console.error(
          "Pair payment API response was not JSON:",
          response.status,
          responseText
        );

        throw new Error(
          "Pair payment request returned an invalid server response (HTTP " +
          response.status +
          ")."
        );
      }
  ...
  window.Pair_SearchParticipant_ =
    Pair_SearchParticipant_;
